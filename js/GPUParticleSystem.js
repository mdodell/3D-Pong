...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = self.PARTICLE_NOISE_TEXTURE || textureLoader.load("images/perlin-512.png");
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	// sprite texture rendered for each particle
	self.particleSpriteTex = self.PARTICLE_SPRITE_TEXTURE || textureLoader.load("images/particle2.png");
